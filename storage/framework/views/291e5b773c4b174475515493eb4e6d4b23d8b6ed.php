...
<table border="2" class="table table-hover" height="100%" width="100%">
	...
	<td>
	<a href="/itemmaster/<?php echo e($it->id); ?>/edit" id="i2">Edit</a> / <a id="i2" href="/itemmaster/<?php echo e($it->id); ?>/destroy">Delete</a>
	</td>
	</tr>
	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</table></center>
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layout.adminmaster", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\inventory\resources\views/itemmaster/index.blade.php ENDPATH**/ ?>